...
/** AArch64 uses the asm-generic syscalls (asm-generic/unistd.h) with the
    following configuration for 64-bit:
 * #define __ARCH_WANT_NEW_STAT
 * #define __ARCH_WANT_SET_GET_RLIMIT
 * #define __ARCH_WANT_SYS_CLONE3
 *
 * The numbers below match riscv64's exactly: both architectures use the
 * generic Linux ABI table from asm-generic/unistd.h.
 */
